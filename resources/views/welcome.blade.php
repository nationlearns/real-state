...
<head>
   ...
   <![endif]-->
    <script nonce="0e67e175-e507-4106-b626-9e567f53b2f2">
        (function(w, d) {
...
<li><a href="{{url('user-login')}}">Login</a></li>
                    ...
                    <div id="numbers">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="number">
                                    <h3><span class="counter" data-from="0" data-to="900" data-speed="1500">0</span>+
                                    </h3>
                                    <p>Hours</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="number">
                                    <h3><span class="counter" data-from="0" data-to="750" data-speed="1500">0</span>+
                                    </h3>
                                    <p>Venues</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="number">
                                    <h3><span class="counter" data-from="0" data-to="50" data-speed="1500">0</span>+
                                    </h3>
                                    <p>Country</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="number">
                                    <h3><span class="counter" data-from="0" data-to="20" data-speed="1500">0</span>+
                                    </h3>
                                    <p>Speakers</p>
                                </div>
                            </div>
    ...
    <div id="video-cta" class="section">
        ...
        <div class="section-bg" style="background-image:url({{ asset('assets/img/background02.jpg') }})"
            data-stellar-background-ratio="0.5"></div>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="events-wrapper">
                        ...
                        <div class="event">
                            ...
                            <div class="event-content">
                                <p class="event-time"><i class="fa fa-clock-o"></i> 8 : 00 AM - 11 : 00 AM</p>
                                <h3 class="event-title">Perpetua consectetuer definitiones id sea, mei utinam eripuit
                                    ne</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua.</p>
                                <p>By <a href="#">John Doe</a></p>
                        ...
                        <div class="event">
                            ...
                            <div class="event-content">
                                <p class="event-time"><i class="fa fa-clock-o"></i> 8 : 00 AM - 11 : 00 AM</p>
                                <h3 class="event-title">At mucius deserunt delicatissimi eam, labitur detraxit ut sit
                                </h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua.</p>
                                <p>By <a href="#">John Doe</a></p>
    ...
    <div id="cta" class="section">
        ...
        <div class="section-bg" style="background-image:url({{ asset('assets/img/background03.jpg') }})"
            data-stellar-background-ratio="0.5"></div>
                ...
                <div class="col-sm-4">
                    <div class="contact">
                        ...
                        <a href="#"><span class="__cf_email__"
                                data-cfemail="b7d2c1d2d9c3f7c4c2c7c7d8c5c399d4d8da">[email&#160;protected]</span></a>
                    </div>
                </div>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317"
        ...
        data-cf-beacon='{"rayId":"81ea1d7f7fb53c00","b":1,"version":"2023.10.0","token":"cd0b4b3a733644fc843ef0b185f98241"}'
