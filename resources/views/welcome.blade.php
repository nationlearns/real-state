        ...
        <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand"><img src="{{ asset('assets/img/logo.png') }}"
                            alt=""></a>
                </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        ...
                        <a href="#" class="fadeInLeft wow btn btn-common btn-lg" data-wow-delay=".6s">Get
                            Ticket</a>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        ...
                        <a href="#" class="fadeInUp wow btn btn-border btn-lg" data-wow-delay=".8s">Learn
                            More</a>
                    </div>
                </div>
                <div class="carousel-item">
                ...
                <div class="schedule-tab-title col-md-3 col-lg-3 col-xs-12">
                    <div class="table-responsive">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="thursday-tab" data-toggle="tab" href="#thursday"
                                    ...
                                    <div id="headingOne">
                                        <div class="collapsed card-header" data-toggle="collapse"
                                            ...
                                            <div class="images-box">
                                                <img class="img-fluid"
                                                    src="{{ asset('assets/img/speaker/speakers-1.jpg') }}"
                                                    alt="">
                                            </div>
                                ...
                                <div class="card">
                                    <div id="headingTwo">
                                        <div class="collapsed card-header" data-toggle="collapse"
                                            ...
                                            <div class="images-box">
                                                <img class="img-fluid"
                                                    src="{{ asset('assets/img/speaker/speakers-2.jpg') }}"
                                                    alt="">
                                            </div>
                                            <span class="time">10am - 12:30pm</span>
                                ...
                                <div class="card">
                                    <div id="headingThree">
                                        <div class="collapsed card-header" data-toggle="collapse"
                                            ...
                                            <div class="images-box">
                                                <img class="img-fluid"
                                                    src="{{ asset('assets/img/speaker/speakers-3.jpg') }}"
                                                    alt="">
                                            </div>
                                            <span class="time">10am - 12:30pm</span>
                                ...
                                <div class="overlay-social-icon text-center">
                                    <ul class="social-icons">
                                        ...
                                        <li><a href="#"><i class="lni-twitter-filled"
                                                    aria-hidden="true"></i></a></li>
                                        <li><a href="#"><i class="lni-linkedin-filled"
                                                    aria-hidden="true"></i></a></li>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="spnsors-logo">
                        <a href="#"><img class="img-fluid"
                                src="{{ asset('assets/img/sponsors/logo-01.png') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="spnsors-logo">
                        <a href="#"><img class="img-fluid"
                                src="{{ asset('assets/img/sponsors/logo-02.png') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="spnsors-logo">
                        <a href="#"><img class="img-fluid"
                                src="{{ asset('assets/img/sponsors/logo-03.png') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="spnsors-logo">
                        <a href="#"><img class="img-fluid"
                                src="{{ asset('assets/img/sponsors/logo-04.png') }}" alt=""></a>
                    </div>
                </div>
                    ...
                    <div class="price-block-wrapper wow fadeInLeft" data-wow-delay="0.2s">
                        ...
                        <div class="pricing-list">
                            <ul>
                                ...
                                <li><i class="lni-check-mark-circle"></i><span class="text">Coffee Break</span>
                                </li>
                                <li><i class="lni-check-mark-circle"></i><span class="text">Lunch on all
                                        days</span></li>
                        ...
                        <div class="pricing-list">
                            <ul>
                                ...
                                <li><i class="lni-check-mark-circle"></i><span class="text">Lunch on all
                                        days</span></li>
                                <li><i class="lni-close"></i><span class="text">Access to all areas</span></li>
                                <li><i class="lni-check-mark-circle"></i><span class="text">Certificate</span>
                                </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="blog-item">
                        <div class="blog-image">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('assets/img/blog/img-1.jpg') }}"
                                    alt="">
                            </a>
                        </div>
                        <div class="descr">
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="blog-item">
                        <div class="blog-image">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('assets/img/blog/img-2.jpg') }}"
                                    alt="">
                            </a>
                        </div>
                        <div class="descr">
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="blog-item">
                        <div class="blog-image">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('assets/img/blog/img-3.jpg') }}"
                                    alt="">
                            </a>
                        </div>
                        <div class="descr">
