...
<!-- Mirrored from uigaint.com/demo/html/anfra/login-register-1/account-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Nov 2023 04:53:18 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="col-lg-7 offset-lg-5 p-sm-0">
              <div class="ugf-content pt340">
                ...
                <div class="account-category">
                  <a href="account-details.html" class="account-type personal">
                    <span class="account-icon"><img src="{{asset('auth/assets/images/account-personal.png')}}" alt=""></span>
                    <p>Personal</p>
                    <span class="icon"><i class="las la-arrow-right"></i></span>
                  </a>
                  <a href="account-details.html" class="account-type business">
                    <span class="account-icon"><img src="{{asset('auth/assets/images/account-business.png')}}" alt=""></span>
                    <p>Buseness</p>
                    <span class="icon"><i class="las la-arrow-right"></i></span>
                  </a>
                </div>
...
<!-- Mirrored from uigaint.com/demo/html/anfra/login-register-1/account-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Nov 2023 04:53:21 GMT -->
</html>
